public class DriveMath {
    public static void main(String[] args) {
        ...
        double encoderTicksConverted = encoderTicks;
        double revolutions = encoderTicksConverted / ticksPerRev;
        ...
        boolean isMoving = !(leftVolts == 0) || !(rightVolts == 0);
        ...
        System.out.println("Inputs: " + "Forward=" + String.format("%.2f", forward) + " | Turn=" + String.format("%.2f", turn) + " | Battery Voltage=" + String.format("%.2f", batteryVolts));
        ...
        System.out.println("Encoder: " + encoderTicks + " Ticks = " + String.format("%.2f", revolutions) + " Revs = " + String.format("%.2f", distanceCm) + "cm");
